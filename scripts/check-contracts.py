...
ERROR_CODES = [
    ...
    'AGENTDOCK_NODE_HAS_DEPLOYMENTS',
    ...
    'AUTH_STATUS_FAILED',
    'CAPTURE_CARD_FAILED',
    'CHECKPOINT_PROMPT_REVISION_CONFLICT',
    'CHECKPOINT_SETTINGS_READ_FAILED',
    'CHECKPOINT_SETTINGS_UNAVAILABLE',
    'CHECKPOINT_SETTINGS_UPDATE_FAILED',
    ...
    'INVALID_BUILTIN_UPDATE',
    'INVALID_CHECKPOINT_PROMPT',
    'INVALID_CREDENTIALS',
    ...
    'MISSING_QUERY',
    'MOVE_FAILED',
    'NODE_SESSION_DELETE_FAILED',
    'NODE_SESSION_LIST_FAILED',
    'NODE_SESSION_READ_FAILED',
    'NODE_SESSION_STORE_UNAVAILABLE',
    'NODE_SESSION_TARGET_REVOKE_FAILED',
    'ORIGIN_REJECTED',
    'PATCH_FAILED',
    'PREVIEW_FAILED',
