...
func TestAllowsHistoricalTargetControlIsActionSpecific(t *testing.T) {
	tests := []struct {
		...
		{name: "browser close", tool: "browser_session", action: "close", want: true},
		{name: "browser start", tool: "browser_session", action: "start", want: false},
		{name: "browser cleanup stale", tool: "browser_session", action: "cleanup_stale", want: false},
		{name: "browser missing action", tool: "browser_session", want: false},
		{name: "browser act", tool: "browser_act", action: "close", want: false},
		{name: "browser snapshot", tool: "browser_snapshot", action: "close", want: false},
